...
Private Function OLD_SYNCHRONOUS_WAIT_COM_PORT(Port_Number As Long, Wait_MilliSeconds As Long) As Boolean
'---------------------------------------------------------------------
...
Loop_Iteration = Int(Wait_Remaining / Loop_Wait_Time) ' + Wait_Remaining Mod Loop_Wait_Time
'Loop_Iteration = Mod(Wait_Remaining / Loop_Wait_Time) ' + LONG_1
...
OLD_SYNCHRONOUS_WAIT_COM_PORT = Data_Waiting
