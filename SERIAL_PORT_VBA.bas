...
Private Declare PtrSafe Function Clear_Com_Error Lib "Kernel32.dll" Alias "ClearCommError" (ByVal Port_Handle As LongPtr, ByRef Error_Mask As Long, ByRef COM_STATUS As COM_PORT_STATUS) As Boolean
