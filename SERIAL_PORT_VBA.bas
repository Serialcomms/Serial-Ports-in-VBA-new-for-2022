...
If Port_Valid Then
     ...
     If Port_Started(Port_Number) Then
        ...
        Temp_Milliseconds = PORT_MICROSECONDS(Port_Number) / LONG_1000
...
End If
    ...
    If Port_Debug Then
        ...
        PORT_MICROSECONDS_END Port_Number
        Receive_Microseconds = Int(PORT_MICROSECONDS(Port_Number))
...
PORT_MICROSECONDS = (COM_PORT(Port_Number).Timers.Timing_QPC_End - COM_PORT(Port_Number).Timers.Timing_QPC_Now) * LONG_1000
