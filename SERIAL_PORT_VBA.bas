...
' returns True if port valid, started and attached device asserts Port DSR signal.
' DSR = Data Set (Modem), signal from attached device or cable configuration.
...
' returns True if port valid, started and attached device asserts Port CTS signal.
' CTS = Clear To Send, signal from attached device or cable configuration.
