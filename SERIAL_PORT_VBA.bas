...
'
Dim Temp_Result As Boolean, Temp_Handle As LongPtr
...
Else:   Detail_Text = Start_Text_6 & Temp_Handle:       End If
Else:   Detail_Text = Start_Text_7 & COM_PORT_RANGE:    End If

If Port_Debug Or Not Port_Valid Then Call PRINT_DEBUG_TEXT(Module_Name, Result_Text, Temp_Name & Detail_Text)
