...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_STARTING, COM_PORT(Port_Number).Name & Start_Text_1 & Port_Number)
...
Const Create_Text_4 As String = " Open for Exclusive Access, Handle = "
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Create_Text_1, COM_PORT(Port_Number).Name & Create_Text_3 & Device_Path)
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Create_Text_2, COM_PORT(Port_Number).Name & Create_Text_6)
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_CONFIG, COM_PORT(Port_Number).Name & Set_Text_1 & Set_Text_2 & Temp_Text)
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_CONFIG, COM_PORT(Port_Number).Name & Set_Text_3 & Temp_Bool)
...
Const Values_Text_1 As String = "PORT_VALUES"
Const Values_Text_2 As String = "FRAME_TIME"
Const Values_Text_3 As String = "SPEED"
Const Values_Text_4 As String = "BUFFER"
Const Values_Text_5 As String = "TIMING"
Const Values_Text_6 As String = "SETTINGS"
...
If Port_Valid Then
    ...
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_6, Port_Name & " Standard Port Settings                = ", COM_PORT(Port_Number).Settings)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_2, Port_Name & " MilliSeconds per Read/Write character = ", COM_PORT(Port_Number).Timers.Frame_MilliSeconds)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_2, Port_Name & " MicroSeconds per Read/Write character = ", COM_PORT(Port_Number).Timers.Frame_MicroSeconds)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_3, Port_Name & " Read/Write speed in Bytes per Second  = ", COM_PORT(Port_Number).Timers.Bytes_Per_Second)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Exit Loop Wait Time Milliseconds      = ", COM_PORT(Port_Number).Timers.Exit_Loop_Wait)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Char Loop Wait Time Milliseconds      = ", COM_PORT(Port_Number).Timers.Char_Loop_Wait)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Data Loop Wait Time Milliseconds      = ", COM_PORT(Port_Number).Timers.Data_Loop_Wait)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Line Loop Wait Time Milliseconds      = ", COM_PORT(Port_Number).Timers.Line_Loop_Wait)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Synch. Read Timeout Microseconds      = ", COM_PORT(Port_Number).Timers.Read_Wait_Time)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_5, Port_Name & " Read/Write 1-Second Timeslice Bytes   = ", COM_PORT(Port_Number).Timers.Timeslice_Bytes)
    Call PRINT_SHOW_TEXT(Values_Text_1, Values_Text_4, Port_Name & " Maximum Synchronous Read Buffer Size  = ", COM_PORT(Port_Number).Buffers.Read_Buffer_Length)
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, "STOPPING", COM_PORT(Port_Number).Name & Stop_Text_1 & Port_Number & " with Handle " & Temp_Handle)
...
Else: Result_Text = TEXT_FAILURE: Detail_Text = Stop_Text_3 & Temp_Handle: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Stop_Text_4 & Temp_Handle: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Stop_Text_5: End If
...
If Port_Valid Then
     ...
     If Port_Started(Port_Number) Then
        ...
        Wait_Text = Wait_String_1 & Wait_MilliSeconds & TEXT_MS
        
        Call PRINT_DEBUG_TEXT(Module_Name, Wait_String_3, COM_PORT(Port_Number).Name & Wait_Text)
        ...
        Wait_Text = Wait_String_5 & PORT_MILLISECONDS(Port_Number) & Wait_String_2 & Wait_Result

        Call PRINT_DEBUG_TEXT(Module_Name, Wait_String_4, COM_PORT(Port_Number).Name & Wait_Text)
...
If Port_Debug Then Temp_Text = COM_PORT(Port_Number).Name & Purge_Text_1 & Temp_Bool & TEXT_COMMA & Purge_Text_2 & Error_Text
...
Const Set_Text_2 As String = " Port Timer Values Applied to Port,"
