...
Private Type COM_PORT_TIMERS
             ...
             Timing_QPC_Now As Currency                    ' Currency-scaled time in QPC MicroSeconds for MicroSecond timing data
             Timing_QPC_End As Currency                    ' Currency-scaled time in QPC MicroSeconds for MicroSecond timing data
...
Const Print_Text_4 As String = " Last Error "
Const Print_Text_5 As String = " Error retrieving Timer Settings for "
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then
        ...
        Error_Text = Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
        Call PRINT_DEBUG_TEXT(Module_Name, TEXT_ERROR, Print_Text_5 & Port_Name & Print_Text_4 & Error_Text)
