...
If Port_Valid Then
     ...
     If Port_Started(Port_Number) Then
        ...
        Temp_Milliseconds = (COM_PORT(Port_Number).Timers.Timing_QPC_End - COM_PORT(Port_Number).Timers.Timing_QPC_Now) / LONG_1000
        
        Wait_Text = Temp_String_5 & Temp_Milliseconds & Temp_String_2 & Wait_Result
...
' DSR = Data Set (Modem), signal from attached device or serial cable configuration.
...
' CTS = Clear To Send, signal from attached device or serial cable configuration.
