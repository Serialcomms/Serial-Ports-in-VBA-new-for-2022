...
Dim Bytes_Per_Second As Long, Transmit_Length As Long, Timeslice_Bytes As Long
Dim Byte_Count As Long, Byte_Pointer As Long, Temp_Pointer As Long, Loop_Counter As Long
...
Dim Temp_Bool As Boolean, Write_Complete As Boolean
...
Call PRINT_SHOW_TEXT(Temp_Text_1, Temp_Text_2, COM_PORT(Port_Number).Name & " Data Set (Modem/Device) Ready  DSR  ", TEXT_EQUALS_SPACE & SIGNAL_DSR)
