...
Const Stop_Text_5 As String = " with Handle "
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_STOPPING, Temp_Name & Stop_Text_1 & Port_Number & Stop_Text_5 & Temp_Handle)
