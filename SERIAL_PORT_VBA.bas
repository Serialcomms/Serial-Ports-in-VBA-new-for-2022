...
Const Start_Text_5 As String = " Failed to Start, Create and Configure COM Port "
...
Const BUFFER_SIZE As String = "BUFFER_SIZE"
...
If Port_Debug Then
    ...
    Call PRINT_DEBUG_TEXT(Module_Name, TEXT_WAITING, COM_PORT(Port_Number).Name & Debug_Text)
End If
...
Else
    ...
    If Port_Debug Then
        ...
        Call PRINT_DEBUG_TEXT(Module_Name, TEXT_FAILED, COM_PORT(Port_Number).Name & Wait_Text_7 & Error_Text)
        Call PRINT_DEBUG_TEXT(Module_Name, TEXT_FAILED, COM_PORT(Port_Number).Name & Wait_Text_8)
    End If
...
Temp_String = Temp_String & "BAUD=" & COM_PORT(Port_Number).DCB.Baud_Rate & TEXT_SPACE
Temp_String = Temp_String & "DATA=" & COM_PORT(Port_Number).DCB.BYTE_SIZE & TEXT_SPACE
Temp_String = Temp_String & "PARITY=" & CONVERT_PARITY(COM_PORT(Port_Number).DCB.PARITY) & TEXT_SPACE
Temp_String = Temp_String & "STOP=" & CONVERT_STOPBITS(COM_PORT(Port_Number).DCB.STOP_BITS) & TEXT_SPACE
