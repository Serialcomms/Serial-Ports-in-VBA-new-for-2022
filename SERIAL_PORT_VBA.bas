...
Temp_Bool = Get_Modem_Status(COM_PORT(Port_Number).Handle, COM_PORT(Port_Number).Line_Signals)
COM_PORT(Port_Number).DLL_Error = Err.LastDllError

If Temp_Bool Then

SIGNAL_CTS = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.CTS_ON, TEXT_ON, TEXT_OFF)
SIGNAL_DSR = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.DSR_ON, TEXT_ON, TEXT_OFF)
SIGNAL_RNG = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.RING_ON, TEXT_ON, TEXT_OFF)
SIGNAL_RLS = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.RLSD_ON, TEXT_ON, TEXT_OFF)
...
Modem_Text = Modem_Text & TIMESTAMP & COM_PORT(Port_Number).Name & Temp_Text_1 & IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.CTS_ON, TEXT_ON, TEXT_OFF) & vbCrLf
Modem_Text = Modem_Text & TIMESTAMP & COM_PORT(Port_Number).Name & Temp_Text_2 & IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.DSR_ON, TEXT_ON, TEXT_OFF) & vbCrLf
'MODEM_TEXT = MODEM_TEXT & TIMESTAMP & COM_PORT(Port_Number).Name & Temp_Text_3 & IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.RING_ON, TEXT_ON, TEXT_OFF) & vbCrLf
'MODEM_TEXT = MODEM_TEXT & TIMESTAMP & COM_PORT(Port_Number).Name & Temp_Text_4 & IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.RLSD_ON, TEXT_ON, TEXT_OFF) & vbCrLf
