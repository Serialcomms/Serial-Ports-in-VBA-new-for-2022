...
Public Function GET_CTS_COM_PORT(Port_Number As Long) As String
'-------------------------------------------------------------------------
Dim Port_Debug As Boolean: Const Module_Name As String = "GET_MODEM_CTS"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
If Port_Valid Then Port_Debug = COM_PORT(Port_Number).Debug
'-------------------------------------------------------------------------
...
Signal_Text = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.CTS_ON, TEXT_ON, TEXT_OFF)

Else

Signal_Text = "ERROR-" & COM_PORT(Port_Number).DLL_Error

End If

Else

Signal_Text = "ERROR-STOPPED-PORT"

End If

Else

Signal_Text = "ERROR-INVALID-PORT"

End If

GET_CTS_COM_PORT = Signal_Text

End Function

Public Function GET_DSR_COM_PORT(Port_Number As Long) As String
'-------------------------------------------------------------------------
Dim Port_Debug As Boolean: Const Module_Name As String = "GET_MODEM_DSR"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
If Port_Valid Then Port_Debug = COM_PORT(Port_Number).Debug
'-------------------------------------------------------------------------
...
Signal_Text = IIf(COM_PORT(Port_Number).Line_Signals And PORT_CONTROL.DSR_ON, TEXT_ON, TEXT_OFF)
