...
Const Config_Text_5 As String = " Failed to Set Port Configuration "

Temp_Result = False

Temp_Settings = CLEAN_PORT_SETTINGS(Port_Settings)

Selected_Settings = IIf(Len(Temp_Settings) > LONG_0, "Supplied Settings", "Default Settings")
...
Else: Result_Text = TEXT_FAILURE: Detail_Text = Config_Text_5 & Port_Settings: End If
...
Const Set_Text_3 As String = " Build Port Device Control Block (DCB), result = "
...
Const Set_Text_6 As String = " Failed to get existing Device Control Block (DCB) Settings "
...
Private Function OLD_SET_PORT_CONFIG(Port_Number As Long, Optional Port_Settings As String) As Boolean
'-------------------------------------------------------------------------
Dim Port_Debug As Boolean: Const Module_Name As String = "SET_PORT_CONFIG"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
If Port_Valid Then Port_Debug = COM_PORT(Port_Number).Debug
...
Dim Result_Text As String, Success_Text As String, Error_Text As String
Dim Detail_Text As String, Failure_Text As String, Temp_String As String
Dim Temp_Result As Boolean, Temp_Build As Boolean, Change_Settings As Boolean

Const Set_Text_1 As String = " Attempting to Set Port With Supplied Settings "
Const Set_Text_2 As String = " Attempting to Set Port With Existing Settings "
Const Set_Text_3 As String = " Build COM Port Device Control Block (DCB), result = "
Const Set_Text_4 As String = " Supplied Settings applied to Port = "
Const Set_Text_5 As String = " Failed to apply configuration settings, Last Error "
Const Set_Text_6 As String = " Failed to get Existing DCB Settings "
Const Set_Text_7 As String = " Using Existing Port Settings,"

Change_Settings = IIf(Len(Port_Settings) > LONG_4, True, False)

Temp_String = IIf(Change_Settings, Set_Text_1 & Port_Settings, Set_Text_2 & GET_PORT_SETTINGS(Port_Number))

If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_CONFIG, COM_PORT(Port_Number).Name & Temp_String)

If GET_PORT_CONFIG(Port_Number) Then          ' get existing com port config (baud, parity etc.) into device control block

If Change_Settings Then
...
OLD_SET_PORT_CONFIG = Temp_Result
...
Dim Temp_Result As Boolean
Dim Progress_Text As String, Success_Text As String, Failure_Text As String, Error_Text As String
