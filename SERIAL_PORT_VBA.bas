...
If Port_Valid Then
    ...
    If Number_Characters < LONG_1 Then Read_Character_Count = COM_PORT(Port_Number).Timers.Timeslice_Bytes
    If Number_Characters > COM_PORT(Port_Number).Timers.Timeslice_Bytes Then Read_Character_Count = COM_PORT(Port_Number).Timers.Timeslice_Bytes
