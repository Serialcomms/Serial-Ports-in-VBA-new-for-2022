...
If COM_PORT_OPEN(Port_Number) Then
...
Private Function COM_PORT_OPEN(Port_Number As Long) As Boolean
'--------------------------------------------------------------------------
Dim Port_Debug As Boolean: Const Module_Name As String = "COM_PORT_OPEN"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
If Port_Valid Then Port_Debug = COM_PORT(Port_Number).Debug
'--------------------------------------------------------------------------
...
Effective_Byte_Count = IIf(Bytes_Per_Second < Read_Buffer_Length, Bytes_Per_Second, Read_Buffer_Length)
...
If Port_Valid Then
    ...
    If Temp_Result Then
        ...
        Signal_State = COM_PORT(Port_Number).Port_Signals And PORT_CONTROL.DSR_ON
...
If Port_Valid Then
    ...
    If Temp_Result Then
        ...
        Signal_State = COM_PORT(Port_Number).Port_Signals And PORT_CONTROL.RING_ON
...
If Port_Valid Then
    ...
    If Temp_Result Then
        ...
        Signal_State = COM_PORT(Port_Number).Port_Signals And PORT_CONTROL.CTS_ON
...
Port_Started = COM_PORT(Port_Number).Handle > LONG_0

End Function

Private Function COM_PORT_CLOSED(Port_Number As Long) As Boolean

COM_PORT_CLOSED = COM_PORT(Port_Number).Handle < LONG_1
