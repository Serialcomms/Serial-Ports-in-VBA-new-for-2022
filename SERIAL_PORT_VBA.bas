...
Dim Temp_Result As Boolean
Dim Temp_Settings As String, Selected_Text As String, Result_Text As String, Detail_Text As String
...
Selected_Text = IIf(Len(Temp_Settings) > LONG_0, Config_Text_1, Config_Text_2)
