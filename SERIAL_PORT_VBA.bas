...
Const Set_Text_7 As String = " Failed to get existing Device Control Block (DCB) Settings "
Const Set_Text_8 As String = " Using Existing Port Settings,"
...
If GET_PORT_CONFIG(Port_Number) Then          ' get existing com port config (baud, parity etc.) into device control block
    ...
    If New_Settings Then
        ...
        If Temp_Build Then
            ...
            Failure_Text = Set_Text_5 & Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
    ...
    Else
        ...
        Temp_Result = True
        Result_Text = TEXT_SUCCESS
        Detail_Text = Set_Text_8 & GET_PORT_SETTINGS_FROM_DCB(Port_Number)
...
Const Modem_Text_6 As String = " Ring Signal                    RING "
