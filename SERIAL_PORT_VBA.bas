...
Const Temp_Text_1 As String = " Attempting to Start and Configure COM Port "
Const Temp_Text_2 As String = " Started and Configured COM Port "
Const Temp_Text_3 As String = " Failed to Configure COM Port "
Const Temp_Text_4 As String = " Failed to Start, Create and Configure COM Port "
Const Temp_Text_5 As String = " Failed to Start COM Port, Existing Port Handle = "
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_STARTING, COM_PORT(Port_Number).Name & Temp_Text_1 & Port_Number)
...
Detail_Text = Temp_Text_2 & Port_Number & " with Handle " & COM_PORT(Port_Number).Handle

Else
Result_Text = TEXT_FAILURE
Detail_Text = Temp_Text_3 & Port_Number
Call STOP_COM_PORT(Port_Number) ' close com port if configure failed
End If
    
Else
Result_Text = TEXT_FAILURE
Detail_Text = Temp_Text_4 & Port_Number
End If

Else
Result_Text = TEXT_FAILURE
Detail_Text = Temp_Text_5 & COM_PORT(Port_Number).Handle
End If
...
Const Temp_Text_1 As String = "CREATING"
Const Temp_Text_2 As String = "PORT_MODE"
Const Temp_Text_3 As String = " Attempting to Open Port with Device Path "
Const Temp_Text_4 As String = " Open for Exclusive Access, Handle = "
Const Temp_Text_5 As String = " Failed to Open COM Port, Last Error "
Const Temp_Text_6 As String = " Creating Synchronous (non-overlapped) mode Port "

Device_Path = DEVICE_PREFIX & CStr(Port_Number)

CREATE_FILE_FLAGS = PORT_FILE_FLAGS.SYNCHRONOUS_MODE

If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Temp_Text_1, COM_PORT(Port_Number).Name & Temp_Text_3 & Device_Path)
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Temp_Text_2, COM_PORT(Port_Number).Name & Temp_Text_6)
...
Case SYSTEM_ERRORS.SUCCESS
    ...
    Temp_Bool = True
    Result_Text = TEXT_SUCCESS
    Detail_Text = Temp_Text_4 & Temp_Handle
...
Case Else
    ...
    Detail_Text = Temp_Text_5 & Error_Text
...
Dim Temp_Bool As Boolean
Dim Temp_Settings As String, Selected_Settings As String, Temp_Text As String, Result_Text As String, Detail_Text As String

Const Temp_Text_1 As String = " Attempting to Configure Port With "
Const Temp_Text_2 As String = " Configured COM Port with Settings = "
Const Temp_Text_3 As String = " Failed to Set Port Values "
Const Temp_Text_4 As String = " Failed to Set Port Timers, Last Error "
Const Temp_Text_5 As String = " Failed to Set Port Config, Last Error "
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, "STARTUP", COM_PORT(Port_Number).Name & Temp_Text_1 & Selected_Settings)

If SET_PORT_CONFIG(Port_Number, Temp_Settings) Then
If SET_PORT_TIMERS(Port_Number) Then
If SET_PORT_VALUES(Port_Number) Then
      Temp_Bool = True
      Result_Text = TEXT_SUCCESS: Detail_Text = Temp_Text_2 & GET_PORT_SETTINGS(Port_Number)
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_3: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_4: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_5: End If
...
Dim Result_Text As String, Success_Text As String, Temp_Text As String
Dim Detail_Text As String, Failure_Text As String, Error_Text As String

Const Temp_Text_1 As String = " Attempting to Set Port  Mode With"
Const Temp_Text_2 As String = " Settings "
Const Temp_Text_3 As String = " Build COM Port DCB result = "
Const Temp_Text_4 As String = " Settings applied to Port"
Const Temp_Text_5 As String = " Failed to apply configuration settings, Last Error "
Const Temp_Text_6 As String = " Failed to get Existing Settings, Last Error "
Const Temp_Text_7 As String = " Using Existing Port Settings,"

Config_Length = Len(Port_Settings)

Temp_Text = IIf(Config_Length > LONG_4, Port_Settings, "= Default")

If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_CONFIG, COM_PORT(Port_Number).Name & Temp_Text_1 & Temp_Text_2 & Temp_Text)
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_CONFIG, COM_PORT(Port_Number).Name & Temp_Text_3 & Temp_Bool)
...
If Temp_Bool Then
   ...
   Error_Text = Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
   Success_Text = Temp_Text_4
   Failure_Text = Temp_Text_5 & Error_Text
...
Else
   ...
   Temp_Bool = False
   Detail_Text = Temp_Text_6 & Error_Text
...
Temp_Bool = True
Result_Text = TEXT_SUCCESS
Detail_Text = Temp_Text_7 & GET_PORT_SETTINGS_FROM_DCB(Port_Number)
...
Dim Timeslice_Byte_Count As Boolean, Temp_Bool As Boolean

' can change wait_characters_nnnn to suit local requirements.

Const WAIT_CHARACTERS_EXIT As Long = 2
...
Const Temp_Text_1 As String = " Attempting to Close Synchronous Port Handle "
Const Temp_Text_2 As String = " Closed Synchronous Port Handle "
Const Temp_Text_3 As String = " Error Closing Port, Last Error "

Port_Handle = COM_PORT(Port_Number).Handle

If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, "CLOSING", COM_PORT(Port_Number).Name & Temp_Text_1 & Port_Handle)
...
Result_Text = TEXT_SUCCESS: Detail_Text = Temp_Text_2 & Port_Handle

Else

Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_3 & Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
...
Const Temp_Text_1 As String = " Attempting to Stop COM Port "
Const Temp_Text_2 As String = " Stopped COM Port with Handle "
Const Temp_Text_3 As String = " Error Closing Port with Handle "
Const Temp_Text_4 As String = " Error Purging Port with Handle "
Const Temp_Text_5 As String = " Failed to Stop COM Port "
...
If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, "STOPPING", COM_PORT(Port_Number).Name & Temp_Text_1 & Port_Number & " with Handle " & Temp_Handle)
...
If CLOSE_PORT_HANDLE(Port_Number) Then
     ...
     COM_PORT(Port_Number).Handle = LONG_0
     Detail_Text = Temp_Text_2 & Temp_Handle
     Result_Text = TEXT_SUCCESS
     Temp_Bool = True
     
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_3 & Temp_Handle: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_4 & Temp_Handle: End If
Else: Result_Text = TEXT_FAILURE: Detail_Text = Temp_Text_5: End If
...
If Port_Valid Then
    ...
    End If
            ...
            Read_Return = SYNCHRONOUS_READ_COM_PORT(Port_Number, Read_Character_Count)
            
            If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_READING, COM_PORT(Port_Number).Name & Temp_Text_3 & Read_Return)
...
Dim Temp_Text As String, Temp_String As String
...
For Loop_Counter = LONG_1 To Transmit_Length Step Timeslice_Bytes
    ...
    If Port_Debug Then Temp_Text = Temp_Text_3 & Loop_Counter & TEXT_TO & Temp_Pointer & Temp_Text_7 & Byte_Count & Temp_Text_8
    If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_WRITING, COM_PORT(Port_Number).Name & Temp_Text)
...
Dim Write_Complete As Boolean, Temp_Bool As Boolean
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then
        ...
        If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, TEXT_RESULT, COM_PORT(Port_Number).Name & Temp_Text_1 & Temp_Bool)
...
Const Temp_Text_1 As String = " Purge All Result = "
Const Temp_Text_2 As String = " Last DLL Error "
...
If Port_Debug Then Temp_Text = COM_PORT(Port_Number).Name & Temp_Text_1 & Temp_Bool & TEXT_COMMA & Temp_Text_2 & Error_Text
...
Const Temp_Text_1 As String = " Port Timers Not Set, Last Error = "
Const Temp_Text_2 As String = " Port Timer Values Applied to Port,"
...
Failure_Text = Temp_Text_1 & Error_Text
Success_Text = Temp_Text_2 & Timer_Text & COM_PORT(Port_Number).Timeouts.Write_Total_Timeout_Constant & TEXT_MS
Result_Text = IIf(Temp_Bool, TEXT_SUCCESS, TEXT_FAILURE)
Detail_Text = IIf(Temp_Bool, Success_Text, Failure_Text)
...
Dim Temp_Bool As Boolean, Temp_Bitmap As Long
...
If Port_Valid Then
    ...
    Else
        ...
        Temp_Text = Error_Prefix & Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)

        If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Status_Text, COM_PORT(Port_Number).Name & Temp_Text)
...
Call PRINT_DEBUG_TEXT(Module_Name, "FRAME_INFO", COM_PORT(Port_Number).Name & Temp_Text & " uS ")
