...
Const Set_Text_6 As String = " Failed to apply configuration settings, Last Error "
Const Set_Text_7 As String = " Failed to build DCB, Last Error = "
...
If GET_PORT_CONFIG(Port_Number) Then          ' get existing com port config (baud, parity etc.) into device control block
    ...
    If New_Settings Then
        ...
        If Temp_Build Then
            ...
            Failure_Text = Set_Text_6 & Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
        ...
        Else
            ...
            Temp_Result = False
            Result_Text = TEXT_FAILURE
            Detail_Text = Set_Text_7 & Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
