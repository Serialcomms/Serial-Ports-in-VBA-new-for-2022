...
'
' The PORT_SETTINGS string should have the same structure as the equivalent command-line Mode arguments for a COM Port:
...
If Port_Valid Then
    ...
    Call PRINT_SHOW_TEXT(Temp_Text_1, Temp_Text_5, Port_Name & " Synch. Read Timeout Microseconds      = ", COM_PORT(Port_Number).Read_Wait_Time)
...
COM_PORT(Port_Number).Timeouts.Write_Total_Timeout_Constant = LONG_0           '
