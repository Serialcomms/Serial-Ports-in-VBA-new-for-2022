...
If Port_Valid Then
     ...
     If Port_Started(Port_Number) Then
        ...
        Temp_Milliseconds = PORT_MILLISECONDS(Port_Number)
...
PORT_MICROSECONDS = Int((COM_PORT(Port_Number).Timers.Timing_QPC_End - COM_PORT(Port_Number).Timers.Timing_QPC_Now) * LONG_1000)

End Function

Private Function PORT_MILLISECONDS(Port_Number As Long) As Long

PORT_MILLISECONDS = Int((COM_PORT(Port_Number).Timers.Timing_QPC_End - COM_PORT(Port_Number).Timers.Timing_QPC_Now))
