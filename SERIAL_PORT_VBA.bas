...
Const Config_Text_5 As String = " Failed to Set Port Timers, Last Error "
...
Const Set_Text_2 As String = " Attempting to Set Port With Existing Settings "
Const Set_Text_3 As String = " Build Device Control Block (DCB), result = "
