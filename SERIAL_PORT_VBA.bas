...
Else
    ...
    If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Temp_Text_1, COM_PORT(Port_Number).Name & Temp_Text_3 & Debug_Text)
...
If Port_Valid Then
        ...
        Temp_Result = Synchronous_Write(COM_PORT(Port_Number).Handle, Put_Character, LONG_1, Write_Byte_Count, ByVal vbNullString)
        COM_PORT(Port_Number).DLL_Error = Err.LastDllError: Error_Text = Decode_System_Errors(COM_PORT(Port_Number).DLL_Error)
...
Call PRINT_SHOW_TEXT(Temp_Text_1, "OVERFLOW ", Port_Name & Error_Text_1, TEXT_EQUALS_SPACE & Temp_Error(LONG_1))
Call PRINT_SHOW_TEXT(Temp_Text_1, "OVERRUN  ", Port_Name & Error_Text_2, TEXT_EQUALS_SPACE & Temp_Error(LONG_2))
Call PRINT_SHOW_TEXT(Temp_Text_1, "PARITY   ", Port_Name & Error_Text_3, TEXT_EQUALS_SPACE & Temp_Error(LONG_3))
Call PRINT_SHOW_TEXT(Temp_Text_1, "FRAMING  ", Port_Name & Error_Text_4, TEXT_EQUALS_SPACE & Temp_Error(LONG_4))
Call PRINT_SHOW_TEXT(Temp_Text_1, "BREAK    ", Port_Name & Error_Text_5, TEXT_EQUALS_SPACE & Temp_Error(LONG_5))
