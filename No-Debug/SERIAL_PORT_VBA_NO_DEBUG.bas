...
If Port_Valid(Port_Number) And COM_PORT_CLOSED(Port_Number) Then
    ...
    If COM_PORT_CREATE(Port_Number) And COM_PORT_CONFIGURE(Port_Number, Port_Setttings) Then
...
If Port_Valid(Port_Number) Then
    ...
    If COM_PORT(Port_Number).Handle > LONG_0 Then Temp_Result = True
...
If Port_Valid(Port_Number) Then
    ...
    If COM_PORT(Port_Number).Handle < LONG_1 Then Temp_Result = True
