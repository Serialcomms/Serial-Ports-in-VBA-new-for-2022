...
If Port_Valid(Port_Number) And COM_PORT_CLOSED(Port_Number) Then
    ...
    If COM_PORT_OPEN(Port_Number) And COM_PORT_CONFIGURE(Port_Number, Port_Setttings) Then
...
If Port_Ready(Port_Number) Then
    ...
    Write_Result = Synchronous_Write(COM_PORT(Port_Number).Handle, Left$(Put_String, LONG_1), LONG_1, Write_Byte_Count)
