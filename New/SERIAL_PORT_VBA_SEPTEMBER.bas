...
Else
    ...
    Error_Text = DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
    Result_Text = TEXT_FAILURE: Detail_Text = Close_Text_3 & Error_Text
...
Const Temp_Text_1 As String = " Port not started, no data available, Last Error "
...
If Port_Debug Then
    ...
    Failure_Text = Temp_Text_1 & DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
...
If Temp_Result Eqv True Then ' re-check this _ JM
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then
      ...
      ' Error_Text = DLL_ERROR_TEXT(Err.LastDllError)
...
Const Clear_Text_2 As String = " DLL Error "
...
If Port_Debug Then
    ...
    Error_Text = DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
    Failure_Text = Clear_Text_2 & Error_Text
    Success_Text = Clear_Text_2 & Error_Text
    Result_Text = IIf(Temp_Result, TEXT_CLEARED, TEXT_FAILED)
    Detail_Text = IIf(Temp_Result, Success_Text, Failure_Text)
...
If Port_Valid Then
    ...
    Else
        ...
        Error_Text = DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
        If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Status_Text, COM_PORT(Port_Number).Name & Error_Text)
...
Public Function DLL_ERROR_TEXT(Error_Code As Long) As String

Dim Error_Text As String

Const ERROR_NUM_PREFIX As String = " ERROR "
...
DLL_ERROR_TEXT = CStr(Error_Code) & ERROR_NUM_SUFFIX & Error_Text
