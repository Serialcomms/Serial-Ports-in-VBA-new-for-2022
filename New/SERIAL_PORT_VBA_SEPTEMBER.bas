...
Const Temp_Text_1 As String = " Port not started, no data available, "
...
Const Purge_Text_2 As String = " Purge Result = "
...
If Port_Debug Then
    Error_Text = DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
    Temp_String = COM_PORT(Port_Number).Name & Purge_Text_2 & Temp_Result & TEXT_COMMA & Error_Text
...
Const Set_Text_1 As String = " Port Timers Not Set, "
...
Const Clear_Text_2 As String = " Clearing, "
...
If Port_Valid Then
    ...
    Else
        ...
        Error_Text = Error_Prefix & DLL_ERROR_TEXT(COM_PORT(Port_Number).DLL_Error)
