...
'
' Public Const ARDUINO As String = "Baud=9600 Data=8 Parity=N Stop=1"
' Public Const BARCODE As String = "Baud=1200 Data=7 Parity=E Stop=1"
'------------------------------------------------------------------------------------------
...
Dim RTS_String As String, Result_Text As String, Detail_Text As String, Debug_Text As String

Const SIGNAL_RTS_LIT As Long = LONG_3
Const SIGNAL_RTS_OFF As Long = LONG_4

Const TEXT_RTS_LIT As String = " State = On "
...
RTS_String = IIf(RTS_State, TEXT_RTS_LIT, TEXT_RTS_OFF)
RTS_Signal = IIf(RTS_State, SIGNAL_RTS_LIT, SIGNAL_RTS_OFF)
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then
            ...
            RTS_Result = Set_Port_Lines(COM_PORT(Port_Number).Handle, RTS_Signal)
            COM_PORT(Port_Number).DLL_Error = Err.LastDllError
                
            If RTS_Result Then
            
                Result_Text = TEXT_SUCCESS
                Detail_Text = Signal_Text_3 & RTS_Result
