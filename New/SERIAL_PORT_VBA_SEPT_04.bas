...
If Port_Valid Then
    ...
    If Temp_Result Then
        ...
        If Port_Debug Then Call PRINT_DEBUG_TEXT(Module_Name, Status_Text, COM_PORT(Port_Number).Name & Device_State & Signal_State)
...
Public Function DEVICE_RINGING(Port_Number As Long) As Boolean
'-------------------------------------------------------------------------
...
Const Status_Text As String = "RING_STATUS"
