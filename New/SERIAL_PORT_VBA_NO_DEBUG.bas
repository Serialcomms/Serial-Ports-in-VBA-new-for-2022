...
Temp_Result = Com_Port_Close(COM_PORT(Port_Number).Handle)
...
'------------------------------------------------------------------------
Const Module_Name As String = "READ_COM_PORT"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'------------------------------------------------------------------------
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then Send_Result = TRANSMIT_COM_PORT(Port_Number, CStr(Send_Variable))
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then Synchronous_Read COM_PORT(Port_Number).Handle, Get_Character, LONG_1, Read_Byte_Count
...
'------------------------------------------------------------------------
Const Module_Name As String = "PURGE_BUFFERS"
'------------------------------------------------------------------------
...
'-------------------------------------------------------------------------
Const Module_Name As String = "DEVICE_READY"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'-------------------------------------------------------------------------
...
'-------------------------------------------------------------------------
Const Module_Name As String = "RING_INDICATE"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'-------------------------------------------------------------------------
...
'-------------------------------------------------------------------------
Const Module_Name As String = "CLEAR_TO_SEND"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'-------------------------------------------------------------------------
...
'-------------------------------------------------------------------------
Const Module_Name As String = "SIGNAL_COM_PORT"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'-------------------------------------------------------------------------
...
If Port_Valid Then
    ...
    If Port_Started(Port_Number) Then
        ...
        If Signal_Valid Then Signal_Result = Set_Com_Signal(COM_PORT(Port_Number).Handle, Signal_Function)
...
'-------------------------------------------------------------------------
Const Module_Name As String = "REQUEST_TO_SEND"
Dim Port_Valid As Boolean: Port_Valid = Port_Number_Valid(Port_Number)
'-------------------------------------------------------------------------
